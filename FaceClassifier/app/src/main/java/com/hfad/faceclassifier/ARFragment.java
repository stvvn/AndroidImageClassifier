...
import com.hfad.faceclassifier.HelperClasses.CameraGrabber;
import com.hfad.faceclassifier.HelperClasses.CameraGrabberListener;
...
public class ARActivity extends AppCompatActivity implements SurfaceHolder.Callback, AREventListener {
    ...
    private void initializeDeepAR() {
        ...
        deepAR.setLicenseKey("20cccb0ce12cf75f15782540a6e9905fc42c80bbfe9f8a3e6752ab4be8279eea5baede4209afa991");
...
public class ARFragment extends Fragment implements SurfaceHolder.Callback, AREventListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(getContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED ||
            ...
            ActivityCompat.requestPermissions(getActivity(), new String[]{ Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO },
                    1);
        } else {
            // Permission has already been granted
            initialize(view);
    ...
    private void initalizeViews(View rootView) {
        ImageButton previousMask = rootView.findViewById(R.id.previousMask);
        previousMask.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        ImageButton nextMask = rootView.findViewById(R.id.nextMask);
        nextMask.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        final RadioButton radioMasks = rootView.findViewById(R.id.masks);
        final RadioButton radioEffects = rootView.findViewById(R.id.effects);
        final RadioButton radioFilters = rootView.findViewById(R.id.filters);

        SurfaceView arView = rootView.findViewById(R.id.surface);
        ...
        final ImageButton screenshotBtn = rootView.findViewById(R.id.recordButton);
        screenshotBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                deepAR.takeScreenshot();
        ...
        ImageButton switchCamera = rootView.findViewById(R.id.switchCamera);
        switchCamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cameraDevice = cameraGrabber.getCurrCameraDevice() ==  Camera.CameraInfo.CAMERA_FACING_FRONT ?  Camera.CameraInfo.CAMERA_FACING_BACK :  Camera.CameraInfo.CAMERA_FACING_FRONT;
        ...
        final TextView screenShotModeButton = rootView.findViewById(R.id.screenshotModeButton);
        final TextView recordModeBtn = rootView.findViewById(R.id.recordModeButton);
        ...
        screenShotModeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(currentSwitchRecording) {
                    if(recording) {
                        Toast.makeText(getActivity(), "Cannot switch to screenshots while recording!", Toast.LENGTH_SHORT).show();
                        return;
                    }
                ...
                if(!currentSwitchRecording) {
                    ...
                    screenshotBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if(recording) {
                                deepAR.stopVideoRecording();
                                Toast.makeText(getActivity(), "Saved video to: " + recordingPath, Toast.LENGTH_LONG).show();
                            } else {
                                deepAR.startVideoRecording(recordingPath);
                                Toast.makeText(getActivity(), "Started video recording!", Toast.LENGTH_SHORT).show();
                            }
                            recording = !recording;
                        }
                    });
